(function () {
    ...
    function getStartupParams() {
        if (typeof __appxStartupParams !== 'undefined' && __appxStartupParams.version) {
    ...
    var StickyFinger = (function () {
            ...
            if (this.stickyFlag) {
                setTimeout(function () {
                    ...
                    _this.socketTask.onOpen(function (res) {
                        ...
                        _this.wsIsOpen = true;
                        _this.socketTaskId = res.data.socketTaskId;
        ...
        StickyFinger.prototype.wrapJSAPI = function () {
            var _this = this;
                ...
                try {
                    my[key] = function () {
                        ...
                        if (key.indexOf('Sync') === -1 && args.length > 0 && typeof args[0] === 'object') {
                            _this.jsapiCallId += 1;
                            var saveCallId_1 = _this.jsapiCallId;
                            _this.sendPerf('Perf.jsapi', {
                                name: key,
                                reqId: saveCallId_1,
                                time: Date.now(),
                                type: 0,
                            ...
                            if (typeof args[0].success === 'function') {
                                var originSuccess_1 = args[0].success;
                            ...
                            if (typeof args[0].fail === 'function') {
                                var originFail_1 = args[0].fail;
                                args[0].fail = function (res) {
                                    _this.sendPerf('Perf.jsapi', {
                                        name: key,
                                        reqId: saveCallId_1,
                                        time: Date.now(),
                            ...
                            _this.jsapiCallId += 1;
                            var saveCallId = _this.jsapiCallId;
                            _this.sendPerf('Perf.jsapi', {
                                name: key,
                                reqId: saveCallId,
                                time: Date.now(),
                    ...
                    this_1.originConsoleAPI.log("[tyro-agent] wrapJSAPI fail " + key + ", " + e);
                }
            };
            var this_1 = this;
        ...
        StickyFinger.prototype.hookJSAPIcall = function () {
            var _this = this;
            var originOnApiCall = null;
            var originOnApiSyncCall = null;
            var originOnApiCallback = null;
            var originOnApiSyncCallback = null;
            ...
            self.__APPX_DEVTOOLS_GLOBAL_HOOK__.onApiCall = function (info) {
            ...
            self.__APPX_DEVTOOLS_GLOBAL_HOOK__.onApiSyncCall = function (info) {
            ...
            self.__APPX_DEVTOOLS_GLOBAL_HOOK__.onApiCallback = function (info) {
            ...
            self.__APPX_DEVTOOLS_GLOBAL_HOOK__.onApiSyncCallback = function (info) {
        ...
        StickyFinger.prototype.processCallFrames = function (contextId, line, scopeUid, stacktrace) {
            ...
            realStacktrace.map(function (stacktrace) {
                ...
                if (scopeVariablesOnlyLocal) {
                    _this.scopeVariables = (_this.contextMap[contextId] !== undefined ? _this.contextMap[contextId].scope[scopeUid] : []);
        ...
        StickyFinger.prototype.handleSticky = function (stickyResponse) {
            ...
            switch (method) {
                ...
                case RequestMethod.GetVariableValue: {
                    ...
                    this.breakStepType = BreakStepType.NextSticky;
                    var variableValueBody = params_1.map(function (v) {
